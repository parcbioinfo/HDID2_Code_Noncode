...
no.gene.ovl.exons.ranges.red.df.bed$seqnames<-paste("chr",no.gene.ovl.exons.ranges.red.df.bed$seqnames,sep="")	
write.table(no.gene.ovl.exons.ranges.red.df.bed,"data/mm10_code-noncode_reduced_non_overlapping_exons.bed", sep="\t",quote=F,col.names=F,row.names=F)	
#' 	
#' 	
...
write.table(pos_strand,"data/mm10_code-noncode_reduced_non_overlapping_exons_pos_strand.bed", sep="\t",quote=F,col.names=F,row.names=F)	
write.table(neg_strand,"data/mm10_code-noncode_reduced_non_overlapping_exons_neg_strand.bed", sep="\t",quote=F,col.names=F,row.names=F)	
#' 	
...
write.table(gaps_bed,"data/mm10_gaps.bed", sep="\t",quote=F,col.names=F,row.names=F)	
#' 	
#' 	
